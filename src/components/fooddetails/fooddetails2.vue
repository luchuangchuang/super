<template>
	...
	<div class=""> 
	    ...
	    <div class="foodrating">
	    	...
	    	<div class="ratings">
	        	<ul>
	        		<li class="allratings"  @click = 'showall()' :class = "{'active':all}" >全部&nbsp;<span>57</span></li>
	        		<li class="satisfyratings"  @click = 'showsatisfy()' :class = "{'active':satisfy}">满意&nbsp;<span>47</span></li>
	        		<li class="unsatisfyratings" @click = 'showunsatisfy()' :class = "{'active':unsatisfy}" >不满意&nbsp;<span>10</span></li>
	        	</ul>
	        	<p   @click = 'onlycontent'> <span class="icon-check_circle" class = "{'active':only}"></span>只看有内容的评价</p>
            </div>
